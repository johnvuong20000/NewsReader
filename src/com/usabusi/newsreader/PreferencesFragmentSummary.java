...
public class PreferencesFragmentSummary extends PreferenceFragment implements
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
			String key) {
        if (sharedPreferences instanceof PreferenceGroup) {
                initSummary();
        } else {
            //updatePrefSummary(p);
            // Update summary
...
//            CheckBoxPreference checkBoxtPref = (CheckBoxPreference) pref;
//            //http://stackoverflow.com/questions/11903346/refresh-android-preferencefragment
//            //checkBoxtPref.setSummary(checkBoxtPref.isChecked());
//            checkBoxtPref.setChecked(!checkBoxtPref.isChecked());
...
//		}
            ...
            String stringValue = pref.toString();

...
//            HeadlinesFragment mHeadlinesFragment = new HeadlinesFragment();
//            transaction.replace(R.id.headlines, mHeadlinesFragment);
            // find our fragments
...
//            curArticle = curPostDatas.get(0);
//            mstrURL=mHeadlinesFragment.getCurrArticleURL();
//            mArticleFragment.loadUrl(mstrURL);
        }
    ...
    public void onHeadlineSelected(int index) {
        ...
        mstrURL=mHeadlinesFragment.getCurrArticleURL();
        if (mstrURL==null) {
            Toast.makeText(getApplicationContext(), "Error Loading URL, it is null", Toast.LENGTH_LONG).show();
            return;
        }
        if (mIsDualPane) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("strURL", mstrURL);
